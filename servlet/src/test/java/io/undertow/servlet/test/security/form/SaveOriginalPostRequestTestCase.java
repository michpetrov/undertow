...
public class SaveOriginalPostRequestTestCase {
    ...
    public void testParametersFromOriginalPostRequest() throws IOException {
        ...
        ClassicHttpResponse result = executePostRequest(client, "/servletContext/dumpRequest", new BasicNameValuePair("param1", "param1Value"), new BasicNameValuePair("param2", "param2Value"));
    ...
    public void testSavedRequestWithWelcomeFile() throws IOException {
        ...
        // this request should be saved and the client redirect to the login form.
        ClassicHttpResponse result = executePostRequest(client, "/servletContext/", new BasicNameValuePair("securedParam1", "securedParam1Value"), new BasicNameValuePair("securedParam2", "securedParam2Value"));
        assertEquals(StatusCodes.OK, result.getCode());
        Assert.assertTrue(HttpClientUtils.readResponse(result).startsWith("j_security_check"));
    ...
    private ClassicHttpResponse executePostRequest(CloseableHttpClient client, String uri, BasicNameValuePair... parameters) throws IOException {
